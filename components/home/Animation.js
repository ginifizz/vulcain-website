    ...
    <Box pl={2} pr={6} position="relative">
      <Paper elevation={20} square className={classes.root} ref={container} id="container">
        <Box position="relative">
          <img className={classes.base} src={`/static/schema2/base.png`} alt="main" />
          <img className={classes.animated} src={`/static/schema2/${method.folder}/step1.png`} alt="step1" id="step1" />
          <img className={classes.animated} src={`/static/schema2/${method.folder}/step2.png`} alt="step2" id="step2" />
          <img
            className={classes.animated}
            src={`/static/schema2/${method.folder}/step2-base.png`}
            alt="step2 circle"
            id="step2-base"
          />
          {method.steps > 2 && (
            <img
              className={classes.animated}
              src={`/static/schema2/${method.folder}/step3.png`}
              alt="step3"
              id="step3"
            />
          )}
          {method.steps > 3 && (
            <>
              <img
                className={classes.animated}
                src={`/static/schema2/${method.folder}/step4.png`}
                alt="step4"
                id="step4"
              />
              <img
                className={classes.animated}
                src={`/static/schema2/${method.folder}/step4-base.png`}
                alt="step4 circle"
                id="step4-base"
              />
            </>
      ...
      <Paper elevation={5} square className={classes.api} id="api">
        <img src="/static/schema2/api.png" alt="api" />
      </Paper>
    </Box>
  );
};
